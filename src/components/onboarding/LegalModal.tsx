  ...
  const termsContent = (
    <div className="space-y-4">
      ...
      <section className="space-y-3">
        ...
        <p className="text-gray-700 leading-relaxed">
          <strong>Приложение принадлежит Волкову Дмитрию Викторовичу</strong>, который является
          правообладателем и администратором Приложения. Все права на Приложение, включая
          исключительные права на использование, принадлежат Волкову Дмитрию Викторовичу.
        </p>
        <p className="text-gray-700 leading-relaxed">
      ...
      <section className="space-y-3">
        ...
        <p className="text-gray-700 leading-relaxed">
          Регистрируясь в Приложении, <strong>вы даете свое согласие на получение SMS-сообщений
          рекламного и информационного характера</strong> на указанный вами номер телефона.
          В случае вашего желания отозвать согласие на получение SMS-сообщений, вам необходимо
          самостоятельно удалить свой аккаунт через настройки Приложения.
        </p>
        <p className="text-gray-700 leading-relaxed">
