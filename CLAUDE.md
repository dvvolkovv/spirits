...
**Состояние i18n в мобилке (на 2026-08-05): не начато.** Нет `flutter_localizations`,
нет `l10n.yaml`, нет `.arb`-файлов; ~858 строк захардкоженной кириллицы в `lib/`.
Пакет `intl` подключён, но только под форматирование дат.
