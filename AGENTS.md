# My.Linkeon (Kindred Spirits) — AGENTS.md
...
Ключевые эндпоинты (полный список — в `~/Downloads/spirits_back/AGENTS.md`):
...
Все существующие авто-тесты живут в `~/Downloads/spirits_back/tests/` (см. `~/Downloads/spirits_back/AGENTS.md`):
